		...
		case 'delete_file':
			if ($delete_files){
				if($ftp){
					...
					if (file_exists('../../thumbs/gallerie/'.$info['filename'] ."." . $info['extension'])){
					    unlink('../../thumbs/gallerie/'.$info['filename'] . "." . $info['extension']);
                    }
				}
		...
		case 'rename_file':
			if ($rename_files){
				...
				if (!empty($name))
				{
					...
					if (file_exists('../../thumbs/gallerie/'.$info['filename'] . "." . $info['extension']))
					rename_file('../../thumbs/gallerie/'.$info['filename'] . "." . $info['extension'],$name,$ftp,$config);
